...
Patch1: ganeti-2.14.0-systemd-sshd.patch
Patch2: ganeti-2.14.0-avoid-systemd-request-repeated.patch
Patch3: ganeti-2.14.0-systemd-options.patch
...
%changelog
* Tue Jan  5 2016 Jun Futagawa <jfut@integ.jp> - 2.14.2-1
- Updated to 2.14.2
